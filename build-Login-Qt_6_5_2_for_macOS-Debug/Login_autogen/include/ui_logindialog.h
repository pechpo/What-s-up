...
public:
    ...
    void setupUi(QDialog *LoginDialog)
    {
        ...
        loginBtn->setGeometry(QRect(290, 220, 89, 25));
        exitBtn = new QPushButton(LoginDialog);
        exitBtn->setObjectName("exitBtn");
        exitBtn->setGeometry(QRect(30, 220, 89, 25));
        registerBtn = new QPushButton(LoginDialog);
        registerBtn->setObjectName("registerBtn");
        registerBtn->setGeometry(QRect(160, 220, 89, 25));
        registerBtn->setAutoRepeat(false);
    ...
    void retranslateUi(QDialog *LoginDialog)
    {
        ...
        registerBtn->setText(QCoreApplication::translate("LoginDialog", "\302\240\346\263\250\345\206\214", nullptr));
    } // retranslateUi
